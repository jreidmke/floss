...
const VerticalFeatures = () => (
  ...
  >
    <VerticalFeatureRow
      ...
      description="Get that dental level clean feeling with our new product. Treat those pearly whites to the latest and greatest in flossing technology. Why go to the dentist, when you can have the dentist at the convience of your house!"
      image="/assets/images/floss1.jpg"
      imageAlt="First feature alt text"
    />
    <VerticalFeatureRow
      title="AI Flossing Technology"
      description="AI may be a buzzword, but we take the buzz out of that word with our automated hygene tool. Our scientists have spent ages perfecting the perfect floss tool, customized to you! Analyze all the data about those beautiful chompers and gums and create a customized flossing profile to YOUR needs, because you are unique."
    ...
    <VerticalFeatureRow
      ...
      description="Our operators are standing by to take your call, there is nothing more we would want then to get you the right device for your needs! Your smile and satisfaction is guarenteed!"
